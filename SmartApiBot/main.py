...
#     except Exception as e:
#         logger.warning(
#             f"⚠️ Candle open not available: {e}. Using LTP instead.")
#         ltp_data = smartApi.ltpData("NSE", tradingsymbol, symboltoken)
  ...
  while True:
    try:
      ...
      if sl_status == "complete":
        logger.info(
            "🎯 Trade complete ✅ — SL executed successfully.  Trade complte ho Gaya....... niklo office ke liye.... (Order ID: {sl_orderid})"
        )
        delete_resume_data()
        break
